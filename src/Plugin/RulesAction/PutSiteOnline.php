...
/**
 * Provides the 'put site online' action.
 *
 * @RulesAction(
 *   id = "dialogflow_rules_put_site_online",
 *   label = @Translation("Put Site Online"),
 *   category = @Translation("Chatbot"),
 *   context = {
 *     "text" = @ContextDefinition("string",
 *       label = @Translation("Text"),
 *       description = @Translation("Put the site online."),
 *       default_value = NULL,
 *       required = false
 *     )
 *   }
 ...
 *
 */
class PutSiteOnline extends RulesActionBase implements ContainerFactoryPluginInterface {
  /**
   * {@inheritdoc}
   */
